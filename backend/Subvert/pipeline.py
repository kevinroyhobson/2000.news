...
9. DEADPAN PROFANITY — A perfectly straight newspaper headline with one casual profanity dropped exactly where a copy editor would never allow it, treated as ordinary vocabulary. The headline never acknowledges the swear: wire-service structure, attribution, and tone stay immaculate, and the profanity reads as weary institutional honesty rather than shock. One swear per headline, placed for rhythm. E.g.: "Fed Holds Interest Rates Steady Because Nobody Fucking Knows Anymore"; "Hurricane Season Begins Whether You've Got Your Shit Together or Not"; "Economy Adds 200,000 Jobs, None of Which Pay Shit".
